      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="col-span-1 md:col-span-2">
            <Link href="/" className="flex items-center space-x-2">
              ...
              <span className="text-xl font-bold text-white">Confidential Copilot</span>
            </Link>
            <p className="mt-4 text-sm text-gray-400 max-w-md">
              Leverage the power of AI while keeping your data completely private and secure.
              Our zero-trust architecture ensures your information never leaves your control.
            </p>
          ...
          <div>
            ...
            <ul className="mt-4 space-y-2">
              <li><Link href="#" className="text-sm text-gray-400 hover:text-white">Document Processing</Link></li>
              <li><Link href="#" className="text-sm text-gray-400 hover:text-white">Chat Mode</Link></li>
              <li><Link href="#" className="text-sm text-gray-400 hover:text-white">Email Mode</Link></li>
              <li><Link href="#" className="text-sm text-gray-400 hover:text-white">Meeting Summarizer</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="mt-4 space-y-2">
              ...
              <li><Link href="#" className="text-sm text-gray-400 hover:text-white">Security</Link></li>
        ...
        <div className="mt-12 pt-8 border-t border-gray-800 flex flex-col md:flex-row justify-between items-center">
          <p className="text-sm text-gray-400">
            &copy; {currentYear} Confidential Copilot. All rights reserved.
          </p>
